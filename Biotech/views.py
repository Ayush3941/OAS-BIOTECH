...
def addsession(request):
    if request.method=="POST":
        ...
        ab=session(session=Session,sessiondate=sessiondate)
        ab.save()
...
def addcourse(request):
    ...
    if request.method=="POST":
        ...
        ab=Course(course_session=course_session,course_name=course_name,course_duration=course_duration,course_fees=course_fees,course_date=course_date)
        ab.save()
